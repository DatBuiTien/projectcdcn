            ...
            <form role="form" name="form-addcate" onsubmit="return cateForm()" action="<?php echo URL_ADMIN_PART?>/controllers/cate_controller.php" method="post" novalidate enctype="multipart/form-data">
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="catename" class="form-control" id="catename" value="<?php echo $_SESSION['cate_info']['cate_name']?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="catelink" class="form-control" id="catelink" value="<?php echo $_SESSION['cate_info']['cate_tenkhongdau']?>">
                    </div>
