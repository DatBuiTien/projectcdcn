...
<div class="main">
    ...
    <div class="content">
        <?php
            foreach ($_SESSION['producttype'] as $key => $producttype){
            $x = 0;
        ?>
        <div class="content_top">
            <div class="heading">
                <h3><?php echo $producttype['pt_name']; ?></h3>
            </div>
            <div class="see">
                <p><a href="producttype_controller.php?producttype=index&cate_name=mobile-phones&id=<?php echo $producttype['id']?>">See all Products</a></p>
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="section group">
            <?php foreach ($_SESSION['product'] as $item => $product) {
                    if ($product['id_producttype'] == $producttype['id']) {
                        $x++;
                        if($x<5){
                        ?>
                        <div class="grid_1_of_4 images_1_of_4" style="margin-left: 0px; width: 237px">
                            ...
                            <div class="price-details">
                                <div class="price-number">
                                    <p><span class="rupees"><?php echo number_format($product['price']) . 'đ'; ?></span>
                                    </p>
                                </div>
                                <div class="add-cart">
                                    <h4>
                                        <a href="product_controller.php?action=index&product=<?php echo $product['id'] ?>">Add
                                            to Cart</a></h4>
                                </div>
                                <div class="clear"></div>
                            </div>
